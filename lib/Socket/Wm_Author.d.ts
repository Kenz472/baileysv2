...
declare class Waguri {
    constructor(
        utils: Waguri.Utils,
        waUploadToServer: Waguri.WAMediaUploadFunction,
    ...
    handleProduct(
        content: { productMessage: Waguri.ProductMessage },
        jid: string,
        quoted?: proto.IWebMessageInfo
    ): Promise<{ viewOnceMessage: proto.Message.ViewOnceMessage }>;

    handleInteractive(
        content: { interactiveMessage: Waguri.InteractiveMessage },
        jid: string,
        quoted?: proto.IWebMessageInfo
    ): Promise<{ interactiveMessage: proto.Message.InteractiveMessage }>;

    handleAlbum(
        content: { albumMessage: Waguri.AlbumItem[] },
        jid: string,
        quoted?: proto.IWebMessageInfo
    ): Promise<any>;

    handleEvent(
        content: { eventMessage: Waguri.EventMessage },
        jid: string,
        quoted?: proto.IWebMessageInfo
    ): Promise<any>;
    ...
    handleGroupStory(
        content: { groupStatusMessage: Waguri.GroupStatusMessage },
        jid: string,
        quoted?: proto.IWebMessageInfo
    ): Promise<any>;
    ...
    buildMessageContent(
        content: any,
        opts?: Waguri.WAMessageContentGenerationOptions
    ): Promise<any>;

    utils: Waguri.Utils;
    relayMessage: (jid: string, content: any, options?: any) => Promise<any>;
    waUploadToServer: Waguri.WAMediaUploadFunction;
    bail: Waguri.BailUtils;
}
